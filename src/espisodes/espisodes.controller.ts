...
export class EspisodesController {
  ...
  async create(@Body() createEspisodeDto: CreateEspisodeDto,
    @Request() req: any,
  ...
  async update(@Param('id') id: string, @Body() updateEspisodeDto: UpdateEspisodeDto, @UploadedFiles() images: Array<Express.Multer.File>,) {
